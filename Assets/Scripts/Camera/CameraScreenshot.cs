...
public class CameraScreenshot : MonoBehaviour
{
    ...
    private async void ImageTest()
    {
        await ImageTestAsync();
        Debug.Log("Image loading complete!");
    }

    async Task ImageTestAsync()
    {
        var imageData = File.ReadAllBytes("Assets/Resources/SaveData/MapScreenShots/MapScreenshot1.jpg");
